...
# относительно предыдущего. Требуется определить номер дня, на который резуль-
# тат спортсмена составит не менее b километров. Программа должна принимать
...
b = int(input('Введите интересующий результат спортсмена (км):'))
d = 1
print(f'{d}-й день: {a}')
while a <= b:
