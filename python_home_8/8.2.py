...
class Cell:
    ...
    def make_order(self, quantity):
        row = ''
        for i in range(int(self.cells / quantity)):
            if self.cells % quantity == 0:
                row += '\\n'
            else:
                row += '\\n' + '*'
        return row
...
print(cell1 / cell2)
print()
print("Oрганизация ячеек по рядам")
print(cell1.make_order(cell1.quantity))
print(cell2.make_order(cell2.quantity))
print(cell3.make_order(cell3.quantity))
print(cell4.make_order(cell4.quantity))
